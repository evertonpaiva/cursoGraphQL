...
class Pet {
  lista() {
    const sql = `SELECT Pets.id, Pets.nome, Pets.tipo, Pets.observacoes, Clientes.id as donoId, Clientes.nome as donoNome, Clientes.cpf donoCpf FROM Pets INNER JOIN Clientes WHERE Pets.donoId = Clientes.id`;
